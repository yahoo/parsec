...
import yjava.servlet.filter.YahooIPFilter;
...
public class ParsecWebListener implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if (System.getProperty("DISABLE_SWAGGER_YNET_PROTECT") == null) {
            FilterRegistration.Dynamic swaggerACL = context.addFilter("swagger_acl", YahooIPFilter.class);

            if (null != swaggerACL) {
                swaggerACL.setInitParameter("ynet-yahoo", "true");
                swaggerACL.addMappingForServletNames(null, true, SWAGGER_UI);
            }
        }
    }
